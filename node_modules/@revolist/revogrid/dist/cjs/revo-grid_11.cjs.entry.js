...
const RevoViewPort = ({ viewports, dimensions, orderRef, nakedClick, registerElement, onScroll }, children) => {
  ...
  let el;
  return [
    index.h("div", { class: "main-viewport", ref: e => el = e, onClick: e => viewPortClick(e, el) },
      index.h("div", { class: "viewports" },
        children,
        index.h("revogr-scroll-virtual", { class: "vertical", dimension: "rgRow", viewportStore: viewports['rgRow'].store, dimensionStore: dimensions['rgRow'].store, ref: el => registerElement(el, 'rowScroll'), onScrollVirtual: e => onScroll(e.detail) }),
        index.h(OrderRenderer, { ref: orderRef }))),
    index.h("revogr-scroll-virtual", { class: "horizontal", dimension: "rgCol", viewportStore: viewports['rgCol'].store, dimensionStore: dimensions['rgCol'].store, ref: el => registerElement(el, 'colScroll'), onScrollVirtual: e => onScroll(e.detail) }),
  ];
};
...
const ViewPortSections = ({ resize, editors, rowClass, readonly, range, columns, useClipboard, columnFilter, registerElement, onEdit, onScroll }) => {
  ...
  for (let view of columns) {
    ...
    const dataViews = [
      index.h("revogr-header", Object.assign({ viewportCol: view.viewportCol }, view.headerProp, { selectionStore: view.columnSelectionStore, slot: HEADER_SLOT, columnFilter: columnFilter, canResize: resize })),
    ];
    view.dataPorts.forEach((data, j) => {
      ...
      const dataView = (index.h("revogr-overlay-selection", Object.assign({}, data, { slot: data.slot, selectionStore: data.segmentSelectionStore, editors: editors, readonly: readonly, range: range, useClipboard: useClipboard, onSetEdit: ({ detail }) => onEdit(detail) }),
        ...
        index.h("revogr-focus", { selectionStore: data.segmentSelectionStore, dimensionRow: data.dimensionRow, dimensionCol: data.dimensionCol })));
...
const CellRenderer = ({ model, canDrag, onDragStart }) => {
  ...
  if (model.column.rowDrag && isRowDragService(model.column.rowDrag, model)) {
    if (canDrag) {
      els.push(index.h("span", { class: DRAGGABLE_CLASS, onMouseDown: e => onDragStart(e) },
        index.h("span", { class: DRAG_ICON_CLASS })));
    }
    else {
      els.push(index.h("span", { class: DRAGGABLE_CLASS }));
    }
  }
...
const RowRenderer = ({ rowClass, size, start, style, depth }, cells) => {
  return (index.h("div", { class: `rgRow ${rowClass || ''}`, style: Object.assign(Object.assign({}, style), { height: `${size}px`, transform: `translateY(${start}px)`, paddingLeft: depth ? `${PADDING_DEPTH * depth}px` : undefined }) }, cells));
};
...
const RevogrData = class {
  ...
  render() {
    ...
    for (let rgRow of rows) {
      ...
      rowsEls.push(index.h(RowRenderer, { rowClass: rowClass, size: rgRow.size, start: rgRow.start }, cells));
    }
    return rowsEls;
  }
  getCellRenderer(rgRow, rgCol, draggable = false, depth = 0) {
    ...
    if (typeof custom !== 'undefined') {
      return index.h("div", Object.assign({}, props), custom);
    }
    ...
    // if regular render
    return (index.h("div", Object.assign({}, props), index.h(CellRenderer, { model: model, canDrag: draggable, onDragStart: e => this.dragStartCell.emit(e) })));
  }
  get element() { return index.getElement(this); }
  static get watchers() { return {
...
const Edit = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.cellEdit = index.createEvent(this, "cellEdit", 3);
  ...
  render() {
    if (this.currentEditor) {
      ...
      return index.h(index.Host, { class: EDIT_INPUT_WR }, this.currentEditor.render(index.h));
    }
    return '';
  }
  get element() { return index.getElement(this); }
...
const ResizableElement = (props, children) => {
  ...
  return (index.h("div", Object.assign({}, props, { ref: (e) => directive === null || directive === void 0 ? void 0 : directive.set(e) }),
    children,
    resizeEls));
};
...
const HeaderCellRenderer = ({ data, props }, children) => {
  ...
  if (data === null || data === void 0 ? void 0 : data.columnTemplate) {
    colTemplate = data.columnTemplate(index.h, data);
  }
  ...
  return (index.h(ResizableElement, Object.assign({}, cellProps),
...
const GroupHeaderRenderer = (p) => {
  ...
  return index.h(HeaderCellRenderer, { data: p.group, props: groupProps });
};
    ...
    if (groups[i]) {
      for (let group of groups[i]) {
        ...
        if (indexFirstVisibleCol > -1) {
          ...
          groupRow.push(index.h(GroupHeaderRenderer, { start: groupStart, end: groupEnd, group: group, canResize: canResize, onResize: e => onResize(e.changedX, groupStartIndex, groupEndIndex) }));
        }
      }
    }
    groupRow.push(index.h("div", { class: `${HEADER_ROW_CLASS} group` }));
  }
  return groupRow;
};
...
const RevogrHeaderComponent = class {
  ...
  render() {
    ...
    for (let rgCol of cols) {
      ...
      cells.push(index.h(HeaderRenderer, { range: range, column: rgCol, data: colData, canFilter: !!this.columnFilter, canResize: this.canResize, onResize: e => this.onResize(e, rgCol.itemIndex), onDoubleClick: e => this.headerdblClick.emit(e), onClick: e => this.initialHeaderClick.emit(e) }));
      visibleProps[colData === null || colData === void 0 ? void 0 : colData.prop] = rgCol.itemIndex;
    }
    return [
      index.h("div", { class: "group-rgRow" }, index.h(ColumnGroupsRenderer, { canResize: this.canResize, visibleProps: visibleProps, groups: this.groups, dimensionCol: this.dimensionCol.state, depth: this.groupingDepth, onResize: (changedX, startIndex, endIndex) => this.onResizeGroup(changedX, startIndex, endIndex) })),
      index.h("div", { class: `${HEADER_ROW_CLASS} ${HEADER_ACTUAL_ROW_CLASS}` }, cells),
    ];
  }
  get element() { return index.getElement(this); }
};
...
const OrderEditor = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.internalRowDragStart = index.createEvent(this, "internalRowDragStart", 7);
    this.internalRowDragEnd = index.createEvent(this, "internalRowDragEnd", 7);
...
class AutoFillService {
  ...
  renderAutofill(range, selectionFocus) {
    ...
    return (index.h("div", { class: CELL_HANDLER_CLASS, style: { left: `${handlerStyle.right}px`, top: `${handlerStyle.bottom}px` }, onMouseDown: (e) => this.selectionStart(e, this.sv.getData(), AutoFillType.autoFill) }));
  }
  get isAutoFill() {
...
class ClipboardService {
  ...
  renderClipboard() {
    return index.h("revogr-clipboard", { onCopyRegion: e => this.onCopy(e.detail), ref: e => (this.clipboard = e), onPasteRegion: e => this.onPaste(e.detail) });
  }
  onPaste(data) {
...
const OverlaySelection = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.internalCopy = index.createEvent(this, "internalCopy", 7);
  ...
  renderRange(range) {
    ...
    return [index.h("div", { class: SELECTION_BORDER_CLASS, style: style })];
  }
  renderEditCell() {
    // if can edit
    ...
    return (index.h("revogr-edit", { onCellEdit: e => this.onCellEdit(e.detail), onCloseEdit: e => this.closeEdit(e), editCell: editable, column: this.columnService.columns[editCell.x], editor: this.columnService.getCellEditor(editCell.y, editCell.x, this.editors), style: style }));
  }
  render() {
...
const RevogrRowHeaders = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.scrollViewport = index.createEvent(this, "scrollViewport", 3);
    this.elementToScroll = index.createEvent(this, "elementToScroll", 3);
  }
  render() {
    var _a;
    const dataViews = [];
    ...
    for (let data of this.dataPorts) {
      ...
      dataViews.push(index.h("revogr-data", Object.assign({}, viewData)));
    ...
    return index.h(index.Host, { class: "rowHeaders", key: "rowHeaders" }, index.h("revogr-viewport-scroll", Object.assign({}, viewportScroll), index.h("revogr-header", Object.assign({}, viewportHeader)), dataViews));
  }
};
...
const RevogrScrollVirtual = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, { 'auto-hide': this.isAutoHide }, { onScroll: (e) => this.onScroll(e) }), index.h("div", { style: { [sizeType]: `${this.extContentSize(this.viewportStore.get('virtualSize'), this.dimensionStore.get('realSize'))}px` } })));
  }
...
const RevogrFocus = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
        ...
        [type || '']: true,
      }, style: style }, index.h("div", { class: directionClass, ref: (e) => (this.el = e) })));
  }
  getRange() {
...
const RevogrViewportScroll = class {
  ...
  render() {
    return (index.h(index.Host, { onScroll: (e) => this.onScroll('rgCol', e) }, index.h("div", { class: "inner-content-table", style: { width: `${this.contentWidth}px` } }, index.h("div", { class: "header-wrapper", ref: e => (this.header = e) }, index.h("slot", { name: HEADER_SLOT })), index.h("div", { class: "vertical-inner", ref: el => (this.verticalScroll = el), onScroll: (e) => this.onScroll('rgRow', e) }, index.h("div", { class: "content-wrapper", style: { height: `${this.contentHeight}px` } }, index.h("slot", { name: CONTENT_SLOT }))), index.h("div", { class: "footer-wrapper", ref: e => (this.footer = e) }, index.h("slot", { name: FOOTER_SLOT })))));
  }
  /**
